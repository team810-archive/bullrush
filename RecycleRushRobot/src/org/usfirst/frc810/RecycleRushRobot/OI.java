...
public class OI {
    ...
    public OI() {
        ...
        closebutton2 = new JoystickButton(manipulator, 7);
        closebutton2.whenPressed(new GripClose());
        openbutton2 = new JoystickButton(manipulator, 5);
        openbutton2.whenPressed(new GripOpen());
        openbutton = new JoystickButton(manipulator, 6);
        openbutton.whenPressed(new GripOpen());
        closebutton = new JoystickButton(manipulator, 8);
        closebutton.whenPressed(new GripClose());
        ...
        SmartDashboard.putData("ElevatorRun", new ElevatorRun());
